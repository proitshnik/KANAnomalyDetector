...
$$
Y\left(T\right)=Y\left(t_1,\ \ldots,\ t_n\right)=\sum_{q=1}^{2n+1}{\mathrm{\Theta}_q\left(\sum_{p=1}^{n}{\theta_{q,p}(t_p)}\right).\ } \qquad(1)
$$
...
$$
\Theta=\theta_{q,p},\quad p=1,2,\ldots,n_{in},\ q=1,2,\ldots,n_{out}. \qquad(2)
$$
...
$$
spline\left(t\right)=\sum_{i}{c_iB_i\left(t\right),} \qquad(4)
$$
...
$$
Y=\left(\Theta_{L-1} \circ \Theta_{L-2} \circ \ldots \circ \Theta_1 \circ \Theta_0\right)T. \qquad(5)
$$
